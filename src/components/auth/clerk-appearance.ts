...
// orange accent (#e08550). Used for the global UserButton (layout/app-shell)
...
export const clerkAppearance = {
  ...
  elements: {
    ...
    footerActionLink: "text-[#e08550] hover:text-[#e08550] hover:underline",
...
export const clerkLightAppearance = {
  ...
  elements: {
    ...
    otpCodeFieldInput:
      "h-12 w-11 rounded-md border border-[#e9e9e7] bg-white text-center text-lg font-semibold text-[#37352f] focus:border-[#e08550] focus:ring-2 focus:ring-[#e08550]/25 focus:outline-none",
    formResendCodeLink: "text-[#e08550] hover:text-[#e08550] font-semibold",
    identityPreview: "rounded-md border border-[#e9e9e7] bg-[#fbfbfa] text-[#37352f]",
    identityPreviewText: "text-[#37352f]",
    identityPreviewEditButton: "text-[#e08550] hover:text-[#e08550]",
    dividerLine: "bg-[#e9e9e7]",
    dividerText: "text-[#787774]",
    footer: "hidden"
  }
