...
export function WobbleCard({ children, className, containerClassName }: WobbleCardProps) {
  ...
  return (
    <div
      ...
      style={{ transform }}
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(140,201,232,0.22),transparent_34%),radial-gradient(circle_at_90%_90%,rgba(224,133,80,0.22),transparent_30%)] opacity-70 transition duration-300 group-hover:opacity-100" />
