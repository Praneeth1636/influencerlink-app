    ...
    <main className="min-h-screen bg-white font-sans text-[#37352f]">
      <header className="border-b border-[#e9e9e7] bg-white/94 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1180px] items-center gap-4 px-5 py-4">
          <div>
            <p className="text-lg font-semibold tracking-[-0.03em]">Analytics</p>
      ...
      <section className="mx-auto grid max-w-[1180px] gap-6 px-5 py-7">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="grid h-10 w-10 place-items-center rounded-lg bg-[#f7f7f5] text-[#787774]">
        ...
        <article className="rounded-[26px] border border-[#e9e9e7] bg-white p-5 shadow-[0_14px_40px_rgba(17,24,39,0.035)]">
          <div className="flex items-center gap-3">
            <BarChart3 className="h-5 w-5 text-[#787774]" />
          ...
          <div className="mt-5 grid gap-3">
            {posts.map((post) => (
              ...
              >
                ...
                <span className="text-sm font-semibold text-[#37352f]">{post.status}</span>
              </div>
            ))}
          </div>
        </article>
